                ...
                <div className='about-body page-content'>
                    <Grid container className='about-grid'>
                        <Grid item xs={12}>
                            ...
                            <p>
                                I am primarily a Java backend developer specializing in Spring, working with both
                                Maven- and Gradle-based projects. I am passionate about learning new technologies and
                                improving my programming skills. I thrive in dynamic environments where I can tackle
                                complex problems and continuously grow as a developer. I am always eager to explore
                                modern frameworks, best practices, and innovative solutions to build efficient and
                                scalable applications. Coming from a financial background, I am a career changer eager
                                to leverage my previous experience in a tech-driven environment. I believe that my
                                analytical mindset as an INTJ 🧠, and my domain knowledge can add value to complex business
                                challenges. I seek a supportive team and leadership where long-term collaboration and
                                professional growth are guaranteed. A strong and encouraging environment is key to
                                achieving great results, and I am excited to contribute my skills while learning from
                                experienced colleagues. Looking forward to joining a team! I enjoy sharing knowledge and
                                supporting others in their growth. I support European values!
                            </p>
